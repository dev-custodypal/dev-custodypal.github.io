...
1. Create a new file in `_collections/_stories/` folder
...
1. Create a new file in the `_collections/_updates/` folder
2. Name it descriptively (e.g., `new-destination.md`)
3. Add your update:
...
2. Drag and drop your `freddy-friends-blog` folder
